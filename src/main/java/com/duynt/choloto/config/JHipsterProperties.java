...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "choloto@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "choloto API";

        private String description = "choloto API documentation";
